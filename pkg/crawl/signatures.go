...
var exactMatches = []exactMatch{
	...
	{
		Versions: []string{"2.9.0-2.14.1", "2.17.0", "2.12.2", "2.6-2.8.2"},
		Match:    []byte{0x2a, 0x01, 0x2b, 0xb7, 0x2a, 0x2c, 0xb5, 0xb1},
	},
	{
		Versions: []string{"2.9.0-2.14.1", "2.16.0", "2.15.0", "2.17.0", "2.6-2.8.2"},
		Match:    []byte{0x12, 0xb6, 0xb2, 0x01, 0xb8, 0xc0, 0xb0},
	},
	{
		Versions: []string{"2.1-2.5"},
		Match:    []byte{0x2a, 0x2b, 0xb7, 0x2a, 0x2c, 0xb5, 0xb1},
	},
	{
		Versions: []string{"2.9.0-2.14.1", "2.6-2.8.2", "2.1-2.5"},
		Match:    []byte{0x2a, 0xb4, 0x2b, 0xb9, 0xb0},
	},
	{
		Versions: []string{"2.9.0-2.14.1", "2.17.0", "2.12.2", "2.6-2.8.2", "2.1-2.5"},
	...
	{
		Versions: []string{"2.9.0-2.14.1", "2.15.0", "2.17.0", "2.12.2", "2.6-2.8.2"},
